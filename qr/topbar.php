    ...
    <nav id="topbar">
        <ul class="navbar-nav theme-brand flex-row  text-center">
            <li class="nav-item theme-logo">
                <a href="/../qr/index.html">
                    <img src="/../qr/assets/img/90x90.jpg" class="navbar-logo" alt="logo">
                </a>
            </li>
            <li class="nav-item theme-text">
                <a href="/../qr/index.php" class="nav-link"> QRv </a>
            </li>
        </ul>
        ...
        <ul class="list-unstyled menu-categories" id="topAccordion">
            ...
            <li class="menu single-menu">
                <a href="/../qr/index.php" class="dropdown-toggle autodroprown">
                    <div class="">
            ...
            <li class="menu single-menu ">
                <a href="/../qr/scanner.php" class="dropdown-toggle autodroprown ">
                    <div class="">
            ...
            <li class="menu single-menu">
                <a href="#vehicle" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <ul class="collapse submenu list-unstyled" id="vehicle" data-parent="#topAccordion">
                    <li>
                        <a href="/../qr/vehicle_info.php">Vehicle Info</a>
                    </li>
                    <li>
                        <a href="/../qr/visitorInfo.php">Visitor Info</a>
                    </li>
                    <li>
                        <a href="/../qr/pendingVisitor.php">Pending Visitor Info</a>
                    </li>
                    <li>
                        <a href="/../qr/vehicle_log.php">Vehicle Log</a>
                    </li>
            ...
            <li class="menu single-menu">
                <a href="/../qr/qrgenerator.php" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            <path fill="#ffffff" d="M0 80C0 53.5 21.5 32 48 32h96c26.5 0 48 21.5 48 48v96c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V80zM64 96v64h64V96H64zM0 336c0-26.5 21.5-48 48-48h96c26.5 0 48 21.5 48 48v96c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V336zm64 16v64h64V352H64zM304 32h96c26.5 0 48 21.5 48 48v96c0 26.5-21.5 48-48 48H304c-26.5 0-48-21.5-48-48V80c0-26.5 21.5-48 48-48zm80 64H320v64h64V96zM256 304c0-8.8 7.2-16 16-16h64c8.8 0 16 7.2 16 16s7.2 16 16 16h32c8.8 0 16-7.2 16-16s7.2-16 16-16s16 7.2 16 16v96c0 8.8-7.2 16-16 16H368c-8.8 0-16-7.2-16-16s-7.2-16-16-16s-16 7.2-16 16v64c0 8.8-7.2 16-16 16H272c-8.8 0-16-7.2-16-16V304zM368 480a16 16 0 1 1 0-32 16 16 0 1 1 0 32zm64 0a16 16 0 1 1 0-32 16 16 0 1 1 0 32z" />
                        </svg>
            ...
            <li class="menu single-menu">
                <a href="/../id/index.php" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
            ...
            <li class="menu single-menu">
                <a href="/../qr/qrvusers.php" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        menuItems.forEach(function(item) {
            if (item.href === currentUrl) {
                item.closest(".menu").classList.add("active");
            }
        });
    });
</script>