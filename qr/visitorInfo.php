												...
												<td class="text-center">
													<div class="btn-group">
														...
														<div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
															...
															<a class="dropdown-item delete-trigger" href="#" data-id="<?php echo $row['id']; ?>" data-rollno="<?php echo $row['name']; ?>" data-toggle="modal" data-target="#deleteConfirmationModal">Delete</a>
																...
																<div class="user-profile">
																	<div class="widget-content widget-content-area">
																		...
																		<div class="text-center user-info" style="margin-top: 3%;">
																			<img src="../assets/vauploads/<?php echo $row['avatarImage']; ?>" alt="avatar" style="width: 90px; height: 90px;">
																		</div>
