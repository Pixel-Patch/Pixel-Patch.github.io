...
<body class="sidebar-noneoverflow">
					...
					<div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
						<div class="widget-content widget-content-area br-6" style="position:relative;">
							...
							<div class="table-responsive mb-4 mt-4" style="margin-top: 0.5rem!important;">
								...
								<button class="btn btn-dark btn-sm" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample" style="font-weight: bold; font-size: 16px; margin-bottom:3%;margin-left:2%;">
									<i class="fa fa-plus"></i> Import CSV
								</button>
								<div class="collapse" id="collapseExample" style="margin-top:-3%">
									<div class="card card-body">
										<div class="form-group col-md-4">
											<form action="import_csv.php" accept-charset="UTF-8" method="post" enctype="multipart/form-data">
												<!-- File input field for CSV file -->
												<div class="form-group">
													<input type="file" name="csv_file" id="csv_file" accept=".csv" class="form-control" style="margin-bottom: 10px;">
												</div>
												<!-- Submit button for the form -->
												<div class="form-group mb-0">
													<div class="d-flex">
														<input type="submit" name="import_csv_btn" class="btn btn-success" style="width: 200px;" value="Import CSV">
													</div>
												</div>
											</form>
										</div>
								...
								<a href="add.php" style="text-decoration: none;">
									<button type="button" class="btn btn-dark btn-sm" style="position: absolute; top: 3%; right: 3.5%; font-weight: bold; font-size: 16px;">
                                ...
                                <div class="collapse" id="collapseExample">
                                    <div class="card card-body">
                                        <div class="form-group col-md-3">
                                            <div class="form-group mb-0">
                                                <input type="text" id="rangeCalendarFlatpickr" placeholder="Select date range" />
                                            </div>
                                        </div>
                                    </div>
                                </div> -->
									...
									<tbody>
										...
										?>
											<tr>
												...
												<td class="text-center"><?php echo $row['Branch_of_Service']; ?></td>
												<td class="text-center"><?php echo $row['Fullname']; ?></td>
												<td class="text-center"><?php echo $row['userType']; ?></td>
												<td class="text-center"><?php echo $row['Office']; ?></td>
												<td class="text-center"><?php echo $row['Vehicle_Model']; ?></td> 
												...
												<td class="text-center">
													<div class="d-flex justify-content-center align-items-center">
														<div class="usr-img-frame mr-3  ">
															<img alt="avatar" class="img-fluid rounded-circle" src="../assets/avataruploads/<?php echo $row['image']; ?>">
														</div>
													</div>
												</td>
												<td class="text-center">
													<div class="btn-group">
														...
														<div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
															<a class="dropdown-item" href="Update.php?3cia=<?php echo $row['id']; ?>">Edit</a>
															<a class="dropdown-item delete-trigger" href="#" data-id="<?php echo $row['id']; ?>" data-rollno="<?php echo $row['Fullname']; ?>" data-toggle="modal" data-target="#deleteConfirmationModal">Delete</a>
																...
																<div class="user-profile">
																	<div class="widget-content widget-content-area">
																		...
																		<div class="text-center user-info" style="margin-top: 3%;">
																			<img src="../assets/avataruploads/<?php echo $row['image']; ?>" alt="avatar" style="width: 180px; height: 180px;">

																			<p class=""><?php echo $row['Rank']; ?> <?php echo $row['Fullname']; ?></p>
																		</div>
																			...
																			<div class="" style="text-align: center;">
																				<ul class="contacts-block list-unstyled" style="display: inline-block; text-align: left; margin-bottom: 3%;margin-top: 3%;">
																					...
																					<li class="contacts-block__item">
																						...
																						</svg><?php echo $row['Cellphone_Number']; ?>
																					</li>
																					<li>
																					...
																					<li class="contacts-block__item">
																						...
																						</svg><?php echo $row['Date_Registered']; ?></a>
																					</li>
																				</ul>
																				<ul style="margin-left: -9%;">
																					...
																					<li class="list-inline-item">
																						<button type="button" class="btn btn-outline-dark mb-2" style="font-weight: bold; font-size: 16px;">
																							<?php echo $row['Vehicle_Plate_Number']; ?>
																					</li>
																					</li>
																					<!-- Add the rest of your list items similarly -->
																				</ul>
																			</div>

																		</div>
																		<div class="text-center user-info" style="margin-top: 3%;">
																			<img src="../assets/dluploads/<?php echo $row['imageDL']; ?>" alt="avatar" style="width: 300px; height: 150px;">
		...
		$('#html5-extension').DataTable({
			...
			buttons: {
				buttons: [{
						...
						className: 'btn',
						exportOptions: {
							columns: [0, 1, 2, 3, 4, 5, 6, 7, 8] // Specify the columns to export
						}
					},
					{
						extend: 'csv',
	...
	<script>
		$(document).ready(function() {
			// Bind the click event to the container div
			$('#container').on('click', '.delete-trigger', function() {
				var rollNo = $(this).data('rollno');
				var id = $(this).data('id');

				$('#rollNoToDelete').text(rollNo);
