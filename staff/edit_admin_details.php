...
<?php 
if ($_SESSION['RollNo']== 'field' OR 'Field' AND 'Field' AND 'admin' OR 'ADMIN' AND 'Admin') {
    ?>
...
$sql1="update QRv.user set Name='$name', EmailId='$email', MobNo='$mobno', Password='$pswd' where RollNo='$rollno'";
