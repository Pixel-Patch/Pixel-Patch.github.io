    ...
    <nav id="topbar">
        <ul class="navbar-nav theme-brand flex-row  text-center">
            ...
            <li class="nav-item theme-text">
                <a href="index.html" class="nav-link"> QRv </a>
            </li>
        </ul>
        ...
        <ul class="list-unstyled menu-categories" id="topAccordion">
            ...
            <li class="menu single-menu ">
                <a href="scanner.php" class="dropdown-toggle autodroprown ">
                    <div class="">
            ...
            <li class="menu single-menu">
                ...
                <ul class="collapse submenu list-unstyled" id="vehicle" data-parent="#topAccordion">
                    <li>
                        <a href="vehicle_info.php">Vehicle Info</a>
                    </li>
                    <li>
                        <a href="vehicle_log.php">Vehicle Log</a>
                    </li>
            ...
            <li class="menu single-menu">
                <a href="qrgenerator.php" class="dropdown-toggle">
                    <div class="">
