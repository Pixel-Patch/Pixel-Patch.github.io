...
<body class="sidebar-noneoverflow">
                                    ...
                                    <div class="user-profile">
                                        <div class="widget-content widget-content-area">
                                            ...
                                            <div class="text-center user-info" style="margin-top: 3%;">
                                                <?php if ($_SESSION['userType'] == 'v_user') { ?>
                                                    <img src="../assets/avataruploads/<?php echo $_SESSION['image']; ?>" alt="avatar" style="width: 300px;">
                                                    <p><?php echo $_SESSION['Rank'] . ' ' . $_SESSION['Fullname']; ?></p>
                                                <?php } else if ($_SESSION['userType'] == 'visitor') { ?>
                                                    <img src="../assets/vauploads/<?php echo $_SESSION['avatarImage']; ?>" alt="avatar" style="width: 300px;">
                                                        ...
                                                        <ul class="contacts-block list-unstyled" style="display: inline-block; text-align: left; margin-bottom: 3%; margin-top: 3%;">
                                                            ...
                                                            <li>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar">
                                                                    ...
                                                                    <line x1="8" y1="2" x2="8" y2="6"></line>
                                                                    <line x1="3" y1="10" x2="21" y2="10"></line>
                                                                </svg><?php echo $_SESSION['birthdate']; ?>
                                                            </li>
                                                            <li class="contacts-block__item">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-briefcase">
                                                                    <rect x="2" y="7" width="20" height="14" rx="2" ry="2"></rect>
                                                                    <path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path>
                                                                </svg><?php echo $_SESSION['sponsor']; ?>
                                                            </li>
                                                            <li class="contacts-block__item">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-plus">
                                                                    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                                                                    ...
                                                                    <line x1="12" y1="18" x2="12" y2="12"></line>
                                                                    <line x1="9" y1="15" x2="15" y2="15"></line>
                                                                </svg><?php echo $_SESSION['dateRegistered']; ?>
                                                            </li>
                                                        </ul>
                                                        <ul>
                                                            <li class="list-inline-item">
                                                                <button type="button" class="btn btn-outline-dark mb-2" style="font-weight: bold; font-size: 16px;">
                                                                    <?php echo $_SESSION['vModel']; ?>
                                                                </button>
                                                            </li>
                                                            <li class="list-inline-item">
                                                                <button type="button" class="btn btn-outline-dark mb-2" style="font-weight: bold; font-size: 16px;">
                                                                    <?php echo $_SESSION['vType']; ?>
                                                                </button>
                                                            </li>
                                                            <li class="list-inline-item">
                                                                <button type="button" class="btn btn-outline-dark mb-2" style="font-weight: bold; font-size: 16px;">
                                                                    <?php echo $_SESSION['vPlateNumber']; ?>
                                                                </button>
                                                            </li>
                                                        </ul>
                                                    <?php } ?>
                        ...
                        <div class="widget-content widget-content-area br-6">
                            <div class="table-responsive mb-4 mt-4" style="margin-top: -0.3rem!important;">
                                ...
                                <table id="alter_pagination" class="table table-hover" style="width:100%;">
                                    ...
                                    <tbody>
                                        <?php
                                        // SQL query to join vehicle_log with v_user and visitor tables
                                        $sql = "
        SELECT
            vehicle_log.*,
    ...
    ";
                                        ...
                                        while ($row = $query->fetch_assoc()) {
                                            // Determine the fullname and plate number based on whether the user or visitor fields are populated
