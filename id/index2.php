<?php include('../qradmin/header.php'); ?>
...
<body class="sidebar-noneoverflow">
    ...
    <?php include('../qradmin/navbar.php'); ?>
    ...
    <div class="main-container" id="container">
        ...
        <!--  BEGIN TOPBAR  -->
        <?php include('../qradmin/topbar.php'); ?>
        <!--  END TOPBAR  -->
        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                                    ...
                                    <div class="card card-outline-secondary">
                                        ...
                                        if ($_SERVER["REQUEST_METHOD"] == "POST" && !empty($_POST['v_userid'])) {
                                            ...
                                            if ($row = $result->fetch_assoc()) {
                                                ...
                                                $qrFilename = $PNG_TEMP_DIR . 'qr_' . $v_userid . '.png';
                                        ...
                                        <div class="card-body" style="display: flex; align-items: center; justify-content: center;">
                                            <form autocomplete="off" class="form" role="form" action="index2.php" method="post" style="width: fit-content;">
                ...
                <?php include('../qradmin/footer.php'); ?>
            </div>
            <!--  END CONTENT PART  -->
        </div>
        <!-- END CONTENT PART -->
