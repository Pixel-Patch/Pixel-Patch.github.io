    ...
    <nav id="topbar">
        <ul class="navbar-nav theme-brand flex-row  text-center">
            <li class="nav-item theme-logo">
                <a href="/QRv/qradmin/index.html">
                    <img src="/QRv/qradmin/assets/img/90x90.jpg" class="navbar-logo" alt="logo">
                </a>
            </li>
            <li class="nav-item theme-text">
                <a href="/QRv/qradmin/index.php" class="nav-link"> QRv </a>
            </li>
        </ul>
        ...
        <ul class="list-unstyled menu-categories" id="topAccordion">
            ...
            <li class="menu single-menu">
                <a href="/QRv/qradmin/index.php" class="dropdown-toggle autodroprown">
                    <div class="">
            ...
            <li class="menu single-menu ">
                <a href="/QRv/qradmin/scanner.php" class="dropdown-toggle autodroprown ">
                    <div class="">
            ...
            <li class="menu single-menu">
                ...
                <ul class="collapse submenu list-unstyled" id="vehicle" data-parent="#topAccordion">
                    <li>
                        <a href="/QRv/qradmin/vehicle_info.php">Vehicle Info</a>
                    </li>
                    <li>
                        <a href="/QRv/qradmin/vehicle_log.php">Vehicle Log</a>
                    </li>
            ...
            <li class="menu single-menu">
                <a href="/QRv/qradmin/qrgenerator.php" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu single-menu">
                <a href="/QRv/id/index2.php" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
