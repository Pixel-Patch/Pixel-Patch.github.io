		...
		<div class="register">
			...
			<form action="addadmin.php" method="post">
				...
				<!-- <select name="Category" id="Category">
					...
					<option value="Lirbary Office Staff ">Library Office Staff </option>
...
if(isset($_POST['signup']))
{
	...
	$sql="insert into qrcodedb.user (Name,Type,Category,RollNo,EmailId,MobNo,Password) values ('$name','$type','$category','$rollno','$email','$mobno','$password')";
